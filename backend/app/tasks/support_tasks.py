...
class SupportTasks:
    ...
    def billing_task(self, agent, query: str):
        return Task(
            description=f"A customer has submitted a query: '{query}'. As the Billing Specialist, you handle Payment issues, Subscriptions, Invoices, and Refunds. Use your Knowledge_Base_Search tool to find relevant information regarding these aspects. Provide the raw facts, policies, and steps needed to solve your part of the problem. If other agents have already provided info, append your findings to theirs.",
    ...
    def faq_task(self, agent, query: str):
        return Task(
            description=f"A customer has submitted a query: '{query}'. As the FAQ Specialist, you handle Company policies, General questions, and Contact information. Use your Knowledge_Base_Search tool to find relevant information regarding these aspects. Provide the raw facts needed to solve your part of the problem. If other agents have already provided info, append your findings to theirs.",
